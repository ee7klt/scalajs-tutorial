...
$c_Ltutorial_webapp_TutorialApp$.prototype.$$js$exported$meth$keyUpMessage__O = (function() {
  this.keyUpMessage__V()
});
...
$c_Ltutorial_webapp_TutorialApp$.prototype.keyUpMessage__V = (function() {
  var content = $as_T($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("myinput").value);
  var mydiv = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("contentdiv");
  mydiv.innerHTML = content
});
$c_Ltutorial_webapp_TutorialApp$.prototype.addClickedMessage__V = (function() {
  var ul = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("myul");
  var content = $as_T($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("myinput").value);
  this.appendListItem__Lorg_scalajs_dom_raw_Node__T__V(ul, content)
});
$c_Ltutorial_webapp_TutorialApp$.prototype.appendListItem__Lorg_scalajs_dom_raw_Node__T__V = (function(targetNode, text) {
  var liNode = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("li");
...
$c_Ltutorial_webapp_TutorialApp$.prototype.$$js$exported$meth$addClickedMessage__O = (function() {
...
$c_Ltutorial_webapp_TutorialApp$.prototype.keyUpMessage = (function() {
  return this.$$js$exported$meth$keyUpMessage__O()
});
$c_Ltutorial_webapp_TutorialApp$.prototype.addClickedMessage = (function() {
